  ...
  return (
    <div className="bg-[#a266cf] p-4 rounded-xl shadow-lg lg:px-5 lg:py-7 pb-10 mb-8">
      ...
      <div className="flex text-center items-center justify-center my-4 w-full ">
        ...
        <div className="text-gray-600 ml-2 lg:ml-4 md:ml-4 text-lg flex">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 lg:h-6 lg:w-6  md:h-6 md:w-6 inline mr-2 text-[#351447]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
          </svg>
          <span className="text-xs lg:text-lg md:text-lg">{moment(post.createdAt).format('DD MMMM, YYYY')}</span>
        </div>
      </div>
      ...
      <div className="text-center w-full">
        <Link href={`/post/${post.slug}`} className="transition duration-300 text-[#f4ecfb] font-medium hover:bg-[#502b64] bg-[#351447] px-6 lg:px-16 md:px-16 py-2 rounded-lg shadow-xl w-full">Continue reading</Link>
      </div>
    </div>
  );
};
